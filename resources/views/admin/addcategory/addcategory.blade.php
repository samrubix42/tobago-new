<div class="max-w-6xl mx-auto space-y-8 p-2">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-6 border-b border-slate-200">
        <div>
            <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Add New Category</h1>
            <p class="text-sm text-slate-500 mt-1">Create a new category for catalog organization.</p>
        </div>
    ...
    <form wire:submit.prevent="save" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <!-- Left Side: Main Form Fields (2 Columns on Large Screens) -->
        ...
        <!-- Right Side: Sidebar Cards (Status, Image, Subcategory config) -->
        <div class="space-y-6">
