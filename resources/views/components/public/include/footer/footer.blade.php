    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-12 grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
            ...
            <div class="flex gap-3 mt-5">
                <a href="https://www.instagram.com/tobacgonoida" target="_blank" rel="noopener noreferrer" class="w-9 h-9 flex items-center justify-center rounded-full border border-subtle bg-white/5 hover:border-white/20 transition">
                    <i class="ri-instagram-line text-sm"></i>
                </a>
                <a href="https://www.facebook.com/noidatobacgo" target="_blank" rel="noopener noreferrer" class="w-9 h-9 flex items-center justify-center rounded-full border border-subtle bg-white/5 hover:border-white/20 transition">
                    <i class="ri-facebook-line text-sm"></i>
                </a>
                <a href="https://in.pinterest.com/tobacgonoida/" target="_blank" rel="noopener noreferrer" class="w-9 h-9 flex items-center justify-center rounded-full border border-subtle bg-white/5 hover:border-white/20 transition">
                    <i class="ri-pinterest-line text-sm"></i>
                </a>
                <a href="https://www.youtube.com/@tobac-go-noida/" target="_blank" rel="noopener noreferrer" class="w-9 h-9 flex items-center justify-center rounded-full border border-subtle bg-white/5 hover:border-white/20 transition">
    ...
    <div class="border-t border-subtle">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted">
            ...
            <div class="flex gap-5">
                <a href="https://techonika.com" target="_blank" rel="noopener noreferrer" class="hover:text-white transition">Powered by Techonika</a>
            </div>
