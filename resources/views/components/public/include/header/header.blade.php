                ...
                <nav class="flex items-center gap-1 text-sm font-medium text-white/60">
                    ...
                    <div class="relative" @mouseenter="dropdown='hookah'" @mouseleave="dropdown=null">
                        ...
                        <div x-show="dropdown==='hookah'" x-transition.origin.top.left
                            ...
                            <a href="{{ route('products.category', ['category' => 'premium-hookah/tobac-go-hookah']) }}" wire:navigate class="block px-3.5 py-2 text-sm font-bold text-orange-400 hover:text-orange-300 hover:bg-white/5 transition-all rounded-lg mx-1">Tobac-Go Exclusive</a>
                            <div class="h-px bg-white/5 mx-2 my-1"></div>
                            <a href="{{ route('products.category', ['category' => 'premium-hookah/vg-france-foggit-hookah']) }}" wire:navigate class="block px-3.5 py-2 text-sm text-white/60 hover:text-white hover:bg-white/5 transition-all rounded-lg mx-1">VG France Foggit</a>
                            ...
                            <a href="{{ route('products.category', ['category' => 'premium-hookah/whiskey-bottle-hookah']) }}" wire:navigate class="block px-3.5 py-2 text-sm text-white/60 hover:text-white hover:bg-white/5 transition-all rounded-lg mx-1">Whiskey Bottle</a>
                            ...
                            <a href="{{ route('products.category', ['category' => 'premium-hookah/digital-smoke-hookah']) }}" wire:navigate class="block px-3.5 py-2 text-sm text-white/60 hover:text-white hover:bg-white/5 transition-all rounded-lg mx-1">Digital Smoke</a>
                            ...
                            <a href="{{ route('products.category', ['category' => 'premium-hookah/tobac-go-car-hookah']) }}" wire:navigate class="block px-3.5 py-2 text-sm text-white/60 hover:text-white hover:bg-white/5 transition-all rounded-lg mx-1">Tobac-Go Car</a>
