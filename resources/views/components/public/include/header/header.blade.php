                ...
                <nav class="flex items-center gap-1 text-sm font-medium text-white/60">
                    ...
                    <div class="relative" @mouseenter="dropdown='hookah'" @mouseleave="dropdown=null">
                        ...
                        <div x-show="dropdown==='hookah'" x-transition.origin.top.left
                            ...
                            <a href="{{ route('products.category', ['category' => 'premium-hookah/tobac-go-hookah']) }}" wire:navigate class="block px-3.5 py-2 text-sm font-bold text-orange-400 hover:text-orange-300 hover:bg-white/5 transition-all rounded-lg mx-1">Tobac-Go Exclusive Hookah</a>
                            <div class="h-px bg-white/5 mx-2 my-1"></div>
                            <a href="{{ route('products.category', ['category' => 'premium-hookah/vg-france-foggit-hookah']) }}" wire:navigate class="block px-3.5 py-2 text-sm text-white/60 hover:text-white hover:bg-white/5 transition-all rounded-lg mx-1">VG France Foggit Hookah</a>
                            <a href="{{ route('products.category', ['category' => 'premium-hookah/thugs-hookah']) }}" wire:navigate class="block px-3.5 py-2 text-sm text-white/60 hover:text-white hover:bg-white/5 transition-all rounded-lg mx-1">Thugs Hookah</a>
                            <a href="{{ route('products.category', ['category' => 'premium-hookah/mya-hookah']) }}" wire:navigate class="block px-3.5 py-2 text-sm text-white/60 hover:text-white hover:bg-white/5 transition-all rounded-lg mx-1">Mya Hookah</a>
                            <a href="{{ route('products.category', ['category' => 'premium-hookah/whiskey-bottle-hookah']) }}" wire:navigate class="block px-3.5 py-2 text-sm text-white/60 hover:text-white hover:bg-white/5 transition-all rounded-lg mx-1">Whiskey Bottle Hookah</a>
                            <a href="{{ route('products.category', ['category' => 'premium-hookah/enrolando-hookah']) }}" wire:navigate class="block px-3.5 py-2 text-sm text-white/60 hover:text-white hover:bg-white/5 transition-all rounded-lg mx-1">Enrolando Hookah</a>
                            <a href="{{ route('products.category', ['category' => 'premium-hookah/dum-hookahs']) }}" wire:navigate class="block px-3.5 py-2 text-sm text-white/60 hover:text-white hover:bg-white/5 transition-all rounded-lg mx-1">DUM Hookahs</a>
                            <a href="{{ route('products.category', ['category' => 'premium-hookah/digital-smoke-hookah']) }}" wire:navigate class="block px-3.5 py-2 text-sm text-white/60 hover:text-white hover:bg-white/5 transition-all rounded-lg mx-1">Digital Smoke Hookah</a>
                            <a href="{{ route('products.category', ['category' => 'premium-hookah/deja-vu-hookah']) }}" wire:navigate class="block px-3.5 py-2 text-sm text-white/60 hover:text-white hover:bg-white/5 transition-all rounded-lg mx-1">Deja Vu Hookah</a>
                            <a href="{{ route('products.category', ['category' => 'premium-hookah/cocoyaya-hookah']) }}" wire:navigate class="block px-3.5 py-2 text-sm text-white/60 hover:text-white hover:bg-white/5 transition-all rounded-lg mx-1">Cocoyaya Hookah</a>
                            <a href="{{ route('products.category', ['category' => 'premium-hookah/tobac-go-car-hookah']) }}" wire:navigate class="block px-3.5 py-2 text-sm text-white/60 hover:text-white hover:bg-white/5 transition-all rounded-lg mx-1">Tobac-Go Car Hookah</a>
                            <a href="{{ route('products.category', ['category' => 'premium-hookah/alshan-hookah']) }}" wire:navigate class="block px-3.5 py-2 text-sm text-white/60 hover:text-white hover:bg-white/5 transition-all rounded-lg mx-1">Alshan Hookah</a>
                            <a href="{{ route('products.category', ['category' => 'premium-hookah/al-akbar-hookah']) }}" wire:navigate class="block px-3.5 py-2 text-sm text-white/60 hover:text-white hover:bg-white/5 transition-all rounded-lg mx-1">Al Akbar Hookah</a>
                        </div>
                    </div>
        ...
        <div class="flex-1 px-4 py-5 space-y-1 overflow-y-auto">
            ...
            <div x-data="{ sub: false }">
                ...
                <div x-show="sub" x-transition class="ml-4 mt-0.5 space-y-0.5 border-l border-white/8 pl-3">
                    <a href="{{ route('products.category', ['category' => 'premium-hookah/tobac-go-hookah']) }}" wire:navigate class="block px-3 py-2.5 rounded-lg text-sm font-bold text-orange-400 hover:text-orange-300 hover:bg-white/5 transition-all">Tobac-Go Exclusive</a>
                    <a href="{{ route('products.category', ['category' => 'premium-hookah/vg-france-foggit-hookah']) }}" wire:navigate class="block px-3 py-2.5 rounded-lg text-sm text-white/50 hover:text-white hover:bg-white/5 transition-all">VG France Foggit</a>
                    <a href="{{ route('products.category', ['category' => 'premium-hookah/thugs-hookah']) }}" wire:navigate class="block px-3 py-2.5 rounded-lg text-sm text-white/50 hover:text-white hover:bg-white/5 transition-all">Thugs Hookah</a>
                    <a href="{{ route('products.category', ['category' => 'premium-hookah/mya-hookah']) }}" wire:navigate class="block px-3 py-2.5 rounded-lg text-sm text-white/50 hover:text-white hover:bg-white/5 transition-all">Mya Hookah</a>
                    <a href="{{ route('products.category', ['category' => 'premium-hookah/whiskey-bottle-hookah']) }}" wire:navigate class="block px-3 py-2.5 rounded-lg text-sm text-white/50 hover:text-white hover:bg-white/5 transition-all">Whiskey Bottle</a>
                    <a href="{{ route('products.category', ['category' => 'premium-hookah/enrolando-hookah']) }}" wire:navigate class="block px-3 py-2.5 rounded-lg text-sm text-white/50 hover:text-white hover:bg-white/5 transition-all">Enrolando Hookah</a>
                    <a href="{{ route('products.category', ['category' => 'premium-hookah/dum-hookahs']) }}" wire:navigate class="block px-3 py-2.5 rounded-lg text-sm text-white/50 hover:text-white hover:bg-white/5 transition-all">DUM Hookahs</a>
                    <a href="{{ route('products.category', ['category' => 'premium-hookah/digital-smoke-hookah']) }}" wire:navigate class="block px-3 py-2.5 rounded-lg text-sm text-white/50 hover:text-white hover:bg-white/5 transition-all">Digital Smoke</a>
                    <a href="{{ route('products.category', ['category' => 'premium-hookah/deja-vu-hookah']) }}" wire:navigate class="block px-3 py-2.5 rounded-lg text-sm text-white/50 hover:text-white hover:bg-white/5 transition-all">Deja Vu Hookah</a>
                    <a href="{{ route('products.category', ['category' => 'premium-hookah/cocoyaya-hookah']) }}" wire:navigate class="block px-3 py-2.5 rounded-lg text-sm text-white/50 hover:text-white hover:bg-white/5 transition-all">Cocoyaya Hookah</a>
                    <a href="{{ route('products.category', ['category' => 'premium-hookah/tobac-go-car-hookah']) }}" wire:navigate class="block px-3 py-2.5 rounded-lg text-sm text-white/50 hover:text-white hover:bg-white/5 transition-all">Tobac-Go Car</a>
                    <a href="{{ route('products.category', ['category' => 'premium-hookah/alshan-hookah']) }}" wire:navigate class="block px-3 py-2.5 rounded-lg text-sm text-white/50 hover:text-white hover:bg-white/5 transition-all">Alshan Hookah</a>
                    <a href="{{ route('products.category', ['category' => 'premium-hookah/al-akbar-hookah']) }}" wire:navigate class="block px-3 py-2.5 rounded-lg text-sm text-white/50 hover:text-white hover:bg-white/5 transition-all">Al Akbar Hookah</a>
                </div>
            </div>
