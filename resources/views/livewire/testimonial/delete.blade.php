...
>
    <template x-teleport="body">
        <div x-show="deleteOpen" class="fixed inset-0 z-[99] flex items-center justify-center px-4">
            ...
            >
                <h3 class="text-lg font-semibold text-slate-900 mb-4">Delete Testimonial</h3>
                <p class="mb-6 text-slate-700">Are you sure you want to delete this testimonial? This action cannot be undone.</p>
