...
{
    public string $title = 'Hookah Shop in Noida | Tobac-Go - Sector 76, Amarpali';
    public string $metaDescription = 'Looking for a hookah shop in Noida? Visit Tobac-Go in Sector 76 for premium hookahs, fresh flavours, and all accessories under one roof. Call 078384 49604.';
    public string $metaKeywords = 'hookah shop in noida, hookah store noida, tobac-go sector 76, hookah flavours noida, hookah accessories noida';
    ...
    public array $hookahCollection = [
        'Tobac-Go Signature Hookahs - In-house line built for smooth draw and long life.',
        'VG France Foggit Hookah - Known for thick smoke and clean airflow.',
        'Cocoyaya Hookah - A popular choice for everyday home use.',
        'Mya Hookah - Elegant designs with reliable performance.',
        'Thugs Hookah - Bold and heavy-duty for serious sessions.',
        'Digital Smoke Hookah - Modern look, great for lounge setups.',
        'Deja Vu Hookah - Compact and travel-ready.',
        'Whiskey Bottle Hookah - Great conversation piece and gifting option.',
        'Car Hookah by Tobac-Go - Compact design for travel and on-the-go use.',
    ];
    ...
    public array $accessories = [
        'Hookah Bowls - Clay, silicone, and phunnel bowls.',
        'Charcoal - Natural coconut shell charcoal and quick-light options.',
        'Heat Management Devices (HMD) - Better heat control and longer sessions.',
        'Hookah Pipes and Hoses - Silicone washable and traditional styles.',
        'Foil and Foil Punchers - Reliable quality for better airflow.',
        'Mouth Tips - Hygienic disposable and reusable options.',
        'Cleaning Brushes - To keep your setup fresh.',
        'Grommets and Seals - Airtight fit and consistent pull.',
        'Ashtrays and Tongs - Practical essentials.',
        'Lighters - Reliable options for coal and setup.',
    ];
    ...
    public array $gallery = [
        ['src' => 'images/hookah-shop-in-noida.webp', 'alt' => 'Hookah shop in Noida Tobac-Go store'],
        ['src' => 'images/TOBAC-GO - Front.webp', 'alt' => 'Tobac-Go front store view'],
        ['src' => 'images/tobac-go-interior.webp', 'alt' => 'Tobac-Go store interior'],
